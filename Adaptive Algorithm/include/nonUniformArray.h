...
template <class Type>
void nonUniformArray<Type>::reserve(int s)
{
	assert(s > 0);
...
template <class Type>
void nonUniformArray<Type>::freeMemory() // clear row i
{
	if (NULL != storeArray) delete[]storeArray;
	storeArray = NULL;
	arraySize = 0;
...
template <class Type>
 void nonUniformArray<Type>::clear(int i) // clear row i
{
...
template <class Type>
void nonUniformArray<Type>::pop_back(int i, int sz)
{
	assert(i >= 0 && i < numRows);
...
template <class Type>
Type & nonUniformArray<Type>::access(int i, int j)
...
template <class Type>
 inline Type* nonUniformArray<Type>::startAddress(int i)
{// return the starting address of the first element at row i
	//assert(i >= 0 && i < numRows);
...
template <class Type>
int nonUniformArray<Type>::size(int i)
...
template <class Type>
int nonUniformArray<Type>::size() // how many rows
{
	return numRows;
}
